...
//
// const IOS_C_OUTPUT: &str = "../../flutter_taggy/ios/Classes/frb.h";
// const MACOS_C_OUTPUT_DIR: &str = "../../flutter_taggy/macos/Classes/";
//
// fn main() {
//     // Tell Cargo that if the input Rust code changes, rerun this build script
//     println!("cargo:rerun-if-changed={}", RUST_INPUT);
//     env::set_var("CARGO_PROFILE_TEST_BUILD_OVERRIDE_DEBUG", "true");
